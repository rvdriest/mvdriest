<template>
  <div>
    <header class="max-h-screen h-[42rem] min-h-[35rem] bg-gradient-to-r from-dark via-[#bd6a0b] to-[#FFBC00] pb-6 flex flex-col relative">
      <!-- <Navbar id="navbar" :sticky="fixedNavbar" class="px-8 py-6 lg:px-20"/> -->
      <Navbar />
      <div class="flex items-center justify-center h-full text-3xl md:text-4xl lg:text-5xl text-center px-8 lg:px-20">
    ...
    <Container class="py-24">
      <div class="flex items-center mb-8">
        <h2 class="text-3xl font-semibold mr-6">Projecten</h2>
        <NuxtLink :to="localePath('/projects')" class="px-8 h-12 rounded flex border-[3px] items-center group">Zie alle <svg viewBox="0 0 19.538 13.886" xmlns="http://www.w3.org/2000/svg" class="h-3 ml-2 group-hover:-rotate-45 transition-transform ease-in-out">
