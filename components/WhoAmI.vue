		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-32">
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-5 ">
				<div class="sm:col-span-2">
					<h2 class="font-semibold text-2xl mb-4">Wie ben ik?</h2>
...
3 Adobe programma's in 2 jaar.</p>
				...
				<div>
					<img src="~/assets/icons/pushup.svg" alt="Brush" class="mb-4 w-16 h-16">
					<h2 class="font-semibold text-xl mb-4">Gedreven</h2>
					<p class="text-gray-600">Ik ben altijd gedreven. Als ik ergens aan begin wil ik er alles aan doen om het beste resultaat naar boven te krijgen.</p>
				</div>
			</div>
